; ModuleID = 'newton_1_1_true-unreach-callbuildCFG.bc'
...
entry:
  ...
  %cmp = fcmp ogt float %0, 0xBFC99999A0000000, !dbg !25
  br i1 %cmp, label %land.rhs, label %land.end, !dbg !25

land.rhs:                                         ; preds = %entry
  %1 = load float* %IN, align 4, !dbg !26
  %cmp1 = fcmp olt float %1, 0x3FC99999A0000000, !dbg !26
  br label %land.end
...
land.end:                                         ; preds = %land.rhs, %entry
  ...
  %conv = fpext float %6 to double, !dbg !35
  %cmp3 = fcmp olt double %conv, 1.000000e-01, !dbg !35
  br i1 %cmp3, label %if.end, label %if.then, !dbg !35

if.then:                                          ; preds = %land.end
  call void @__VERIFIER_error(), !dbg !37
...
!0 = metadata !{i32 786449, metadata !1, i32 12, metadata !"clang version 3.5.2 (tags/RELEASE_352/final)", i1 false, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !"", i32 1} ; [ DW_TAG_compile_unit ] [/home/lich/Documents/test_CFG_v4/newton_1_1_true-unreach-call.c] [DW_LANG_C99]
!1 = metadata !{metadata !"newton_1_1_true-unreach-call.c", metadata !"/home/lich/Documents/test_CFG_v4"}
!2 = metadata !{}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/lich/Documents/test_CFG_v4/newton_1_1_true-unreach-call.c]
...
!27 = metadata !{i32 786443, metadata !1, metadata !10, i32 43, i32 3, i32 1, i32 1} ; [ DW_TAG_lexical_block ] [/home/lich/Documents/test_CFG_v4/newton_1_1_true-unreach-call.c]
!28 = metadata !{i32 43, i32 3, metadata !29, null}
!29 = metadata !{i32 786443, metadata !1, metadata !10, i32 43, i32 3, i32 2, i32 2} ; [ DW_TAG_lexical_block ] [/home/lich/Documents/test_CFG_v4/newton_1_1_true-unreach-call.c]
...
!35 = metadata !{i32 53, i32 6, metadata !36, null}
!36 = metadata !{i32 786443, metadata !1, metadata !10, i32 53, i32 6, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/lich/Documents/test_CFG_v4/newton_1_1_true-unreach-call.c]
!37 = metadata !{i32 54, i32 5, metadata !36, null}
!38 = metadata !{i32 56, i32 3, metadata !10, null}
