; ModuleID = 'sin_interpolated_bigrange_loose_true-unreach-call.bc'
...
entry:
  ...
  call void @llvm.dbg.declare(metadata !{double* %r}, metadata !83), !dbg !84
  %call = call double (...)* @__VERIFIER_nondet_double(), !dbg !85
  store double %call, double* %a, align 8, !dbg !85
  %0 = load double* %a, align 8, !dbg !86
  %cmp = fcmp oge double %0, -1.000000e+10, !dbg !86
  br i1 %cmp, label %land.rhs, label %land.end, !dbg !86

land.rhs:                                         ; preds = %entry
  %1 = load double* %a, align 8, !dbg !87
  %cmp1 = fcmp ole double %1, 1.000000e+10, !dbg !87
  br label %land.end

land.end:                                         ; preds = %land.rhs, %entry
  %2 = phi i1 [ false, %entry ], [ %cmp1, %land.rhs ]
  %land.ext = zext i1 %2 to i32, !dbg !89
  call void @__VERIFIER_assume(i32 %land.ext), !dbg !89
  %3 = load double* %a, align 8, !dbg !91
  %call2 = call double @SIN(double %3), !dbg !91
  store double %call2, double* %r, align 8, !dbg !91
  %4 = load double* %r, align 8, !dbg !92
  %cmp3 = fcmp oge double %4, -1.000000e+05, !dbg !92
  br i1 %cmp3, label %land.rhs4, label %land.end6, !dbg !92

land.rhs4:                                        ; preds = %land.end
  %5 = load double* %r, align 8, !dbg !93
  %cmp5 = fcmp ole double %5, 1.000000e+05, !dbg !93
  br label %land.end6

land.end6:                                        ; preds = %land.rhs4, %land.end
  %6 = phi i1 [ false, %land.end ], [ %cmp5, %land.rhs4 ]
  %land.ext7 = zext i1 %6 to i32, !dbg !95
  call void @__VERIFIER_assert(i32 %land.ext7), !dbg !95
  ret i32 0, !dbg !97
}
...
!0 = metadata !{i32 786449, metadata !1, i32 12, metadata !"clang version 3.5.2 (tags/RELEASE_352/final)", i1 false, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !19, metadata !2, metadata !"", i32 1} ; [ DW_TAG_compile_unit ] [/home/lich/Documents/test_CFG_v4/sin_interpolated_bigrange_loose_true-unreach-call.c] [DW_LANG_C99]
!1 = metadata !{metadata !"sin_interpolated_bigrange_loose_true-unreach-call.c", metadata !"/home/lich/Documents/test_CFG_v4"}
!2 = metadata !{}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/lich/Documents/test_CFG_v4/sin_interpolated_bigrange_loose_true-unreach-call.c]
...
!31 = metadata !{i32 786443, metadata !1, metadata !4, i32 12, i32 40, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/lich/Documents/test_CFG_v4/sin_interpolated_bigrange_loose_true-unreach-call.c]
!32 = metadata !{i32 12, i32 49, metadata !33, null}
!33 = metadata !{i32 786443, metadata !1, metadata !34, i32 12, i32 49, i32 2, i32 6} ; [ DW_TAG_lexical_block ] [/home/lich/Documents/test_CFG_v4/sin_interpolated_bigrange_loose_true-unreach-call.c]
!34 = metadata !{i32 786443, metadata !1, metadata !31, i32 12, i32 49, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/lich/Documents/test_CFG_v4/sin_interpolated_bigrange_loose_true-unreach-call.c]
!35 = metadata !{i32 12, i32 58, metadata !36, null}
!36 = metadata !{i32 786443, metadata !1, metadata !34, i32 12, i32 58, i32 3, i32 7} ; [ DW_TAG_lexical_block ] [/home/lich/Documents/test_CFG_v4/sin_interpolated_bigrange_loose_true-unreach-call.c]
!37 = metadata !{i32 12, i32 80, metadata !38, null}
!38 = metadata !{i32 786443, metadata !1, metadata !4, i32 12, i32 80, i32 1, i32 5} ; [ DW_TAG_lexical_block ] [/home/lich/Documents/test_CFG_v4/sin_interpolated_bigrange_loose_true-unreach-call.c]
...
!60 = metadata !{i32 786443, metadata !1, metadata !13, i32 125, i32 7, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/lich/Documents/test_CFG_v4/sin_interpolated_bigrange_loose_true-unreach-call.c]
!61 = metadata !{i32 125, i32 20, metadata !62, null}
!62 = metadata !{i32 786443, metadata !1, metadata !60, i32 125, i32 20, i32 1, i32 8} ; [ DW_TAG_lexical_block ] [/home/lich/Documents/test_CFG_v4/sin_interpolated_bigrange_loose_true-unreach-call.c]
...
!68 = metadata !{i32 786443, metadata !1, metadata !14, i32 131, i32 7, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/lich/Documents/test_CFG_v4/sin_interpolated_bigrange_loose_true-unreach-call.c]
!69 = metadata !{i32 131, i32 21, metadata !70, null}
!70 = metadata !{i32 786443, metadata !1, metadata !68, i32 131, i32 21, i32 1, i32 9} ; [ DW_TAG_lexical_block ] [/home/lich/Documents/test_CFG_v4/sin_interpolated_bigrange_loose_true-unreach-call.c]
...
!76 = metadata !{i32 786443, metadata !1, metadata !15, i32 137, i32 7, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/lich/Documents/test_CFG_v4/sin_interpolated_bigrange_loose_true-unreach-call.c]
!77 = metadata !{i32 137, i32 20, metadata !78, null}
!78 = metadata !{i32 786443, metadata !1, metadata !76, i32 137, i32 20, i32 1, i32 10} ; [ DW_TAG_lexical_block ] [/home/lich/Documents/test_CFG_v4/sin_interpolated_bigrange_loose_true-unreach-call.c]
...
!83 = metadata !{i32 786688, metadata !16, metadata !"r", metadata !5, i32 143, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [r] [line 143]
!84 = metadata !{i32 143, i32 13, metadata !16, null}
!85 = metadata !{i32 145, i32 7, metadata !16, null}
!86 = metadata !{i32 146, i32 3, metadata !16, null}
!87 = metadata !{i32 146, i32 3, metadata !88, null}
!88 = metadata !{i32 786443, metadata !1, metadata !16, i32 146, i32 3, i32 1, i32 11} ; [ DW_TAG_lexical_block ] [/home/lich/Documents/test_CFG_v4/sin_interpolated_bigrange_loose_true-unreach-call.c]
!89 = metadata !{i32 146, i32 3, metadata !90, null}
!90 = metadata !{i32 786443, metadata !1, metadata !16, i32 146, i32 3, i32 2, i32 12} ; [ DW_TAG_lexical_block ] [/home/lich/Documents/test_CFG_v4/sin_interpolated_bigrange_loose_true-unreach-call.c]
!91 = metadata !{i32 148, i32 7, metadata !16, null}
!92 = metadata !{i32 150, i32 3, metadata !16, null}
!93 = metadata !{i32 150, i32 3, metadata !94, null}
!94 = metadata !{i32 786443, metadata !1, metadata !16, i32 150, i32 3, i32 1, i32 13} ; [ DW_TAG_lexical_block ] [/home/lich/Documents/test_CFG_v4/sin_interpolated_bigrange_loose_true-unreach-call.c]
!95 = metadata !{i32 150, i32 3, metadata !96, null}
!96 = metadata !{i32 786443, metadata !1, metadata !16, i32 150, i32 3, i32 2, i32 14} ; [ DW_TAG_lexical_block ] [/home/lich/Documents/test_CFG_v4/sin_interpolated_bigrange_loose_true-unreach-call.c]
!97 = metadata !{i32 151, i32 3, metadata !16, null}
